...
#ifndef M_PI
	#define M_PI 0x1.921fb54442d1846ap+1
#endif

#ifndef M_PI_2
	#define M_PI_2 0x1.921fb54442d1846ap+0
#endif

#ifndef M_TAU
	#define M_TAU 0x1.921fb54442d1846ap+2
#endif
...
#define m_m_mod_N(a, m, n) { n = (((a % m) < 0) ? ((a % m) + m) : (a % m)); }
	...
	#define m_m_pow(x, y, x_pow_y) { x_pow_y = pow(x, y); }
	...
	#define m_m_pow(x, y, x_pow_y) { x_pow_y = powf(x, y); }
